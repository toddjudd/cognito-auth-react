  ...
  const onSubmit = handleSubmit(
    async (data) => {
      try {
        ...
        console.log('signin', await Auth.signIn(data.email, data.password));
        console.log('current', await Auth.currentAuthenticatedUser());
        console.log('remember', await Auth.rememberDevice());
